...
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/153.jpg')),
  :position => 1,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/DSC_0080.JPG')),
  :position => 2,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/DSC_0087.JPG')),
  :position => 3,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/DSC_0094.JPG')),
  :position => 4,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/079.jpg')),
  :position => 5,
  :featured => true,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/DSC_0116.JPG')),
  :position => 6,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/DSC_0150.JPG')),
  :position => 7,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/DSC_0132.JPG')),
  :position => 8,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/DSC_0170.JPG')),
  :position => 9,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/DSC_0178.JPG')),
  :position => 10,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/DSC_0146.JPG')),
  :position => 11,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/073.jpg')),
  :position => 12,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/172.jpg')),
  :position => 13,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_graham/134.jpg')),
  :position => 14,
  :featured => false,
  :published => true)
...
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Badminton-court-1.jpg')),
  :position => 1,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Bathroom-upstairs.jpg')),
  :position => 2,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Bedroom-4.jpg')),
  :position => 3,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Bedroom-1.jpg')),
  :position => 4,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Bedroom-2.jpg')),
  :position => 5,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Drawing-room.jpg')),
  :position => 6,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Front gate open.jpg')),
  :position => 7,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Front.jpg')),
  :position => 8,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Kitchen-table.jpg')),
  :position => 9,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/kitchen.jpg')),
  :position => 10,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Pool.jpg')),
  :position => 11,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Rear-side.jpg')),
  :position => 12,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Stairs.jpg')),
  :position => 13,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_seriamis/Villa-rear.jpg')),
  :position => 14,
  :featured => false,
  :published => true)
...
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Aerial-view.jpg')),
  :position => 1,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Bed-1.jpg')),
  :position => 2,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Bed-3.jpg')),
  :position => 3,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Bed-4.jpg')),
  :position => 4,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Dining.jpg')),
  :position => 5,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Front.jpg')),
  :position => 6,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Kitchen.jpg')),
  :position => 7,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Lounge.JPG')),
  :position => 8,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Pool-1.jpg')),
  :position => 9,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Pool-2.jpg')),
  :position => 10,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_soleia/Veranda off lounge.JPG')),
  :position => 11,
  :featured => false,
  :published => true)
...
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_stuart/DSC_0228.JPG')),
  :position => 1,
  :featured => true,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_stuart/DSC_0229.JPG')),
  :position => 2,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_stuart/DSC_0230.JPG')),
  :position => 3,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_stuart/DSC_0231.JPG')),
  :position => 4,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_stuart/DSC_0233.JPG')),
  :position => 5,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_stuart/DSC_0234.JPG')),
  :position => 6,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_stuart/DSC_0235.JPG')),
  :position => 7,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_stuart/DSC_0236.JPG')),
  :position => 8,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_stuart/DSC_0237.JPG')),
  :position => 9,
  :featured => false,
  :published => true)
...
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_savina/DSCF3849.JPG')),
  :position => 1,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_savina/DSCF5997.JPG')),
  :position => 2,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_savina/DSCF6004.JPG')),
  :position => 3,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_savina/DSCF6021.JPG')),
  :position => 4,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_savina/hpim0001.jpg')),
  :position => 5,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_savina/s5000624.jpg')),
  :position => 6,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_savina/SANY0005.JPG')),
  :position => 7,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_savina/SANY0180.JPG')),
  :position => 8,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_savina/SANY0225.JPG')),
  :position => 9,
  :featured => false,
  :published => true)
...
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_ferrat/photo.JPG')),
  :position => 1,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_ferrat/photo_02.JPG')),
  :position => 2,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_ferrat/photo_03.JPG')),
  :position => 3,
  :featured => false,
  :published => true)
...
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0199.JPG')),
  :position => 1,
  :featured => true,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0198.JPG')),
  :position => 2,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0197.JPG')),
  :position => 3,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0200.JPG')),
  :position => 4,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0201.JPG')),
  :position => 5,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0202.JPG')),
  :position => 6,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0203.JPG')),
  :position => 7,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0204.JPG')),
  :position => 8,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0205.JPG')),
  :position => 9,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0206.JPG')),
  :position => 10,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0207.JPG')),
  :position => 11,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0208.JPG')),
  :position => 12,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0209.JPG')),
  :position => 13,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0210.JPG')),
  :position => 14,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0211.JPG')),
  :position => 15,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0212.JPG')),
  :position => 16,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0213.JPG')),
  :position => 17,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0214.JPG')),
  :position => 18,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0215.JPG')),
  :position => 19,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0216.JPG')),
  :position => 20,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0217.JPG')),
  :position => 21,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0219.JPG')),
  :position => 22,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0220.JPG')),
  :position => 23,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0221.JPG')),
  :position => 24,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_tony/DSC_0222.JPG')),
  :position => 25,
  :featured => false,
  :published => true)
...
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/Front-4.jpg')),
  :position => 1,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/Kitchen-2.JPG')),
  :position => 2,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/Ours-bath-1.jpg')),
  :position => 3,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/Ours-bed-1.jpg')),
  :position => 4,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/Ours-bed-2.jpg')),
  :position => 5,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/Oursinade-lounge-1.jpg')),
  :position => 6,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/patio.jpg')),
  :position => 7,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/Pool-2.JPG')),
  :position => 8,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/Terrace-1.jpg')),
  :position => 9,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/Terrace-5.jpg')),
  :position => 10,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_oursinade/Villa.jpg')),
  :position => 11,
  :featured => false,
  :published => true)
...
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/apartment_seagulls/Balconies.jpg')),
  :position => 1,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/apartment_seagulls/Bed-3.jpg')),
  :position => 2,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/apartment_seagulls/Kitchen-1.JPG')),
  :position => 3,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/apartment_seagulls/Lounge.JPG')),
  :position => 4,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/apartment_seagulls/Main bath-shower.jpg')),
  :position => 5,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/apartment_seagulls/Main bath.jpg')),
  :position => 6,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/apartment_seagulls/Quayside windows.jpg')),
  :position => 7,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/apartment_seagulls/Restaurants.jpg')),
  :position => 8,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/apartment_seagulls/Seagulls balcony.jpg')),
  :position => 9,
  :featured => false,
  :published => true)
...
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/A typical summer view.JPG')),
  :position => 1,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Bedroom 3 v.JPG')),
  :position => 2,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Bedroom 3.JPG')),
  :position => 3,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/chambre de maitre 1.JPG')),
  :position => 4,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/chambre de maitre 2.JPG')),
  :position => 5,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Chambre de maitre terrasse.JPG')),
  :position => 6,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Dining 1.JPG')),
  :position => 7,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Ensuite 1.JPG')),
  :position => 8,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Ensuite 2.JPG')),
  :position => 9,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/garden 2.JPG')),
  :position => 10,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Garden to right.JPG')),
  :position => 11,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Lounge 1.JPG')),
  :position => 12,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Lounge 3.JPG')),
  :position => 13,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Lounge 4.JPG')),
  :position => 14,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Lounge 5.JPG')),
  :position => 15,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Lounge 6.JPG')),
  :position => 16,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Pool from summer kitchen.JPG')),
  :position => 17,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Roof garden 1.JPG')),
  :position => 18,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Sejour dining.jpg')),
  :position => 19,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/Summer kitchen.JPG')),
  :position => 20,
  :featured => false,
  :published => true)
p.photos.create(
  :title => '',
  :description => '',
  :image => File.open(File.join('http://s3-eu-west-1.amazonaws.com/', 'bdp-assets-staging/properties/villa_cap_d_antibes/View to East.jpg')),
  :position => 21,
  :featured => false,
  :published => true)
